export const Uploader = ({ uploadHandler }) => {
    return (
        <div className="h-48 mt-5 flex flex-col rounded shadow-md hover:shadow-xl border-[rgba(255,255,255,.20)] bg-[rgba(255,255,255,.25)]">
            ...
            <div className="flex flex-grow justify-center items-center">
                ...
                <div className="rounded border border-dashed  border-[rgba(255,255,255,.3)]  bg-[rgba(255,255,255,.3)]  h-[8rem] w-56">
                    <label className="h-full flex flex-col justify-center items-center hover:cursor-pointer " htmlFor="image">
                        ...
                        <input onChange={(e) => uploadHandler(e.target.files[0])} id="image" className="opacity-0 h-0" type="file" alt="" />
                    </label>
                </div>
