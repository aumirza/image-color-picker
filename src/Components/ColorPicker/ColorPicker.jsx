...
export const ColorPicker = ({ selectedColor, tempColor }) => {
    ...
    const selectedColorRgb = selectedColor ? rgbToRgbString(selectedColor) : '#000'
    ...
    return (
        ...
        <div className="rounded-md w-72 shadow-md hover:shadow-xl border-[rgba(255,255,255,.20)] bg-[rgba(255,255,255,.25)]">
            ...
            <div className="flex py-5 px-3">
                ...
                <div className="mr-5">
                    <div style={{ background: selectedColorHex }} className="h-16 w-16 rounded-md shadow-md"></div>
                    <div style={{ background: tempColorHex }} className="h-10 w-16 rounded-md mt-3 shadow-md"></div>
                </div>

                <div className="flex flex-col items-center">

                    <ColorInput label={'HEX:'} inputText={selectedColorHex} />
                    <ColorInput label={'RGB:'} inputText={selectedColorRgb} />
