import React, { useRef, useLayoutEffect, useState, createRef, useEffect } from 'react';

export const Canvas = ({ loadedImg, height, width, setSelectedColor,
    setTempColor, setImageData, setCatchingHover }) => {
    ...
    useEffect(() => {
        touchCatcher.current.addEventListener('touchmove', onTouchMove, { passive: false })
    }, [touchCatcher])
    ...
    return (
        <div ref={boxRef} className="relative">
            ...
            <div ref={touchCatcher} {...{ onMouseDown, onMouseMove, onMouseEnter, onMouseLeave }}
