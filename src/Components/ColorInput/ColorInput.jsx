...
export const ColorInput = ({ label, inputText }) => {
    ...
    return (
        <div className="relative flex h-8 bg-[rgba(255,255,255,.3)] rounded items-center px-2 font-mono my-0.5">
            ...
            <label >{label}</label>
            <input className="w-24 bg-transparent" value={inputText} readOnly type="text" />
            ...
            <svg
                className={`h-5 w-5  hover:cursor-pointer text-gray-700 opacity-75 transform ${(copied ? "scale-110" : "")}`}
